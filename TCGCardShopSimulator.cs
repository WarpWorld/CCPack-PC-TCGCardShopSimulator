...
namespace CrowdControl.Games.Packs.TCGCardShopSimulator
{
    ...
    public class TCGCardShopSimulator : SimpleTCPPack
    {
        ...
        public override EffectList Effects => new List<Effect>
        {
                ...
                new Effect("Send Small Cabinet", "furniture_small_cabinet") { Description = "Send the Player a Small Cabinet!", Category = "Furniture"},
                new Effect("Send Small Metal Rack", "furniture_small_metal_rack") { Description = "Send the player a Small Metal Rack", Category = "Furniture"},
                new Effect("Send Play Table", "furniture_play_table") { Description = "Send the player a Play Table", Category = "Furniture"},
                new Effect("Send Small Personal Shelf", "furniture_small_personal_shelf") { Description = "Send a Personal Shelf", Category = "Furniture"},
                new Effect("Send Single Sided Shelf", "furniture_single_sided_shelf") { Description = "Send a Single Sided Shelf", Category = "Furniture"},
                new Effect("Send Card Table", "furniture_card_table") { Description = "Send a Card Table", Category = "Furniture"},
                new Effect("Send Small Warehouse Shelf", "furniture_small_warehouse_shelf") { Description = "Send a Small Warehouse Shelf", Category = "Furniture"},
                new Effect("Send Small Card Display", "furniture_small_card_display") { Description = "Send a Small Card Display", Category = "Furniture"},
                new Effect("Send Auto Scent M100", "furniture_auto_scent_m100") { Description = "Send an Auto Scent M100", Category = "Furniture"},
                new Effect("Send Workbench", "furniture_workbench") { Description = "Send a Workbench", Category = "Furniture"},
                new Effect("Send Double Sided Shelf", "furniture_double_sided_shelf") { Description = "Send a Double Sided Shelf", Category = "Furniture"},
                new Effect("Send Big Warehouse Shelf", "furniture_big_warehouse_shelf") { Description = "Send a Big Warehouse Shelf", Category = "Furniture"},
                new Effect("Send Checkout Counter", "furniture_checkout_counter") { Description = "Send a Checkout Counter", Category = "Furniture"},
                new Effect("Send Auto Scent G500", "furniture_auto_scent_g500") { Description = "Send an Auto Scent G500", Category = "Furniture"},
                new Effect("Send Card Display Table", "furniture_card_display_table") { Description = "Send a Card Display Table", Category = "Furniture"},
                new Effect("Send Big Personal Shelf", "furniture_big_personal_shelf") { Description = "Send a Big Personal Shelf", Category = "Furniture"},
                new Effect("Send Vintage Card Table", "furniture_vintage_card_shelf") { Description = "Send a Vintage Card Table", Category = "Furniture"},
                new Effect("Send Wide Shelf", "furniture_wide_shelf") { Description = "Send a Wide Shelf", Category = "Furniture"},
                new Effect("Send Huge Personal Shelf", "furniture_huge_personal_shelf") { Description = "Send a Huge Personal Shelf", Category = "Furniture"},
                new Effect("Send Auto Scent T1000", "furniture_auto_scent_t1000") { Description = "Send Auto Scent t1000", Category = "Furniture"},
                new Effect("Send Big Card Display", "furniture_big_card_display") { Description = "Send Big Card Display", Category = "Furniture"},
