...
namespace CrowdControl.Games.Packs.TCGCardShopSimulator
{
    ...
    public class TCGCardShopSimulator : SimpleTCPPack
    {
        ...
        public override EffectList Effects => new List<Effect>
        {
                ...
                new Effect("Send Small Personal Shelf", "furniture_small_personal_shelf") { Description = "Speak!", Category = "Furniture"},
                new Effect("Send Single Sided Shelf", "furniture_single_sided_shelf") { Description = "Speak!", Category = "Furniture"},
                new Effect("Send Card Table", "furniture_card_table") { Description = "Speak!", Category = "Furniture"},
                new Effect("Send Small Warehouse Shelf", "furniture_small_warehouse_shelf") { Description = "Speak!", Category = "Furniture"},
                new Effect("Send Small Card Display", "furniture_small_card_display") { Description = "Speak!", Category = "Furniture"},
                new Effect("Send Auto Scent M100", "furniture_auto_scent_m100") { Description = "Speak!", Category = "Furniture"},
                new Effect("Send Workbench", "furniture_workbench") { Description = "Speak!", Category = "Furniture"},
                new Effect("Send Double Sided Shelf", "furniture_double_sided_shelf") { Description = "Speak!", Category = "Furniture"},
                new Effect("Send Big Warehouse Shelf", "furniture_big_warehouse_shelf") { Description = "Speak!", Category = "Furniture"},
                new Effect("Send Checkout Counter", "furniture_checkout_counter") { Description = "Speak!", Category = "Furniture"},
                new Effect("Send Auto Scent G500", "furniture_auto_scent_g500") { Description = "Speak!", Category = "Furniture"},
                new Effect("Send Card Display Table", "furniture_card_display_table") { Description = "Speak!", Category = "Furniture"},
                new Effect("Send Big Personal Shelf", "furniture_big_personal_shelf") { Description = "Speak!", Category = "Furniture"},
                new Effect("Send Vintage Card Table", "furniture_vintage_card_shelf") { Description = "Speak!", Category = "Furniture"},
                new Effect("Send Wide Shelf", "furniture_wide_shelf") { Description = "Speak!", Category = "Furniture"},
                new Effect("Send Huge Personal Shelf", "furniture_huge_personal_shelf") { Description = "Speak!", Category = "Furniture"},
                new Effect("Send Auto Scent T1000", "furniture_auto_scent_t1000") { Description = "Speak!", Category = "Furniture"},
                new Effect("Send Big Card Display", "furniture_big_card_display") { Description = "Speak!", Category = "Furniture"},
