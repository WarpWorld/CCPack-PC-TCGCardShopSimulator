...
namespace CrowdControl.Games.Packs.TCGCardShopSimulator
{
    ...
    public class TCGCardShopSimulator : SimpleTCPPack
    {
        ...
        public overrideLists => new List>
        {
                ...
                new("Throw Player Item", "throwitem") { Description = "Make the player throw their item!", Category = "Player" },
                new("High Sensitivity", "sensitivityhigh") { Description = "Set the Sensitivity for the Player Controls High, making them dizzy", Duration = 30, Category = "Player" },
                new("Low Sensitivity", "sensitivitylow") { Description = "Set the Sensitivity for the Player Controls Super Low.", Duration = 30, Category = "Player" },
                ...
                new("Force Large Bills", "largebills") { Description = "Force customers that are paying with cash to use \"Large Bills\".", Duration = 60, Category = "Payments" },
                new("Force Exact Change", "exactchange") { Description = "Customers pay with Exact amounts when using Cash!", Duration = 60, Category = "Payments" },
                new("Make the streamer do the Math", "forcemath") { Description = "Force The Player to do Math", Duration = 30, Category = "Payments" },
                ...
                new("Hey Ohhh", "speak_heyoo") { Description = "Speak!", Category = "Speak" },

                new("Send Small Cabinet", "furniture_small_cabinet") { Description = "Send the Player a Small Cabinet!", Category = "Furniture" },
                new("Send Small Metal Rack", "furniture_small_metal_rack") { Description = "Send the player a Small Metal Rack", Category = "Furniture" },
                new("Send Play Table", "furniture_play_table") { Description = "Send the player a Play Table", Category = "Furniture" },
                new("Send Small Personal Shelf", "furniture_small_personal_shelf") { Description = "Send a Personal Shelf", Category = "Furniture" },
                new("Send Single Sided Shelf", "furniture_single_sided_shelf") { Description = "Send a Single Sided Shelf", Category = "Furniture" },
                new("Send Card Table", "furniture_card_table") { Description = "Send a Card Table", Category = "Furniture" },
                new("Send Small Warehouse Shelf", "furniture_small_warehouse_shelf") { Description = "Send a Small Warehouse Shelf", Category = "Furniture" },
                new("Send Small Card Display", "furniture_small_card_display") { Description = "Send a Small Card Display", Category = "Furniture" },
                new("Send Auto Scent M100", "furniture_auto_scent_m100") { Description = "Send an Auto Scent M100", Category = "Furniture" },
                new("Send Workbench", "furniture_workbench") { Description = "Send a Workbench", Category = "Furniture" },
                new("Send Double Sided Shelf", "furniture_double_sided_shelf") { Description = "Send a Double Sided Shelf", Category = "Furniture" },
                new("Send Big Warehouse Shelf", "furniture_big_warehouse_shelf") { Description = "Send a Big Warehouse Shelf", Category = "Furniture" },
                new("Send Checkout Counter", "furniture_checkout_counter") { Description = "Send a Checkout Counter", Category = "Furniture" },
                new("Send Auto Scent G500", "furniture_auto_scent_g500") { Description = "Send an Auto Scent G500", Category = "Furniture" },
                new("Send Card Display Table", "furniture_card_display_table") { Description = "Send a Card Display Table", Category = "Furniture" },
                new("Send Big Personal Shelf", "furniture_big_personal_shelf") { Description = "Send a Big Personal Shelf", Category = "Furniture" },
                new("Send Vintage Card Table", "furniture_vintage_card_shelf") { Description = "Send a Vintage Card Table", Category = "Furniture" },
                new("Send Wide Shelf", "furniture_wide_shelf") { Description = "Send a Wide Shelf", Category = "Furniture" },
                new("Send Huge Personal Shelf", "furniture_huge_personal_shelf") { Description = "Send a Huge Personal Shelf", Category = "Furniture" },
                new("Send Auto Scent T1000", "furniture_auto_scent_t1000") { Description = "Send Auto Scent t1000", Category = "Furniture" },
                new("Send Big Card Display", "furniture_big_card_display") { Description = "Send Big Card Display", Category = "Furniture" },
